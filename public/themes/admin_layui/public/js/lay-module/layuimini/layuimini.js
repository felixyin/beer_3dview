...
layui.define(["element", "jquery"], function (exports) {
    ...
    layuimini = new function () {
         ...
         * @param data
         */
        this.myinit = function (data) {
            var loading = layer.load(0, {shade: false, time: 2 * 1000});
            layuimini.initBgColor();
            layuimini.initDevice();
            if (data == null) {
                layuimini.msg_error('没有菜单信息');
            } else {
        ...
        this.initHome = function (data) {
            ...
            $('#layuiminiHomeTabIframe').html('<iframe width="100%" height="100%" frameborder="0"  src="' + href + '"></iframe>');
        };
